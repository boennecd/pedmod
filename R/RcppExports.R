...
.get_biconnected_components <- function(from, to, weights_ids, weights) {
    .Call(`_pedmod_get_biconnected_components`, from, to, weights_ids, weights)
}

.get_block_cut_tree <- function(from, to, weights_ids, weights) {
    .Call(`_pedmod_get_block_cut_tree`, from, to, weights_ids, weights)
}

.get_max_balanced_partition <- function(from, to, weights_ids, weights, slack, max_kl_it_inner, max_kl_it, trace) {
    .Call(`_pedmod_get_max_balanced_partition`, from, to, weights_ids, weights, slack, max_kl_it_inner, max_kl_it, trace)
}
