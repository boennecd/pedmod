...
type of family which consists of two couples which are related through by one 
of the parents being cousins.
...
We source a file to get a function to simulate a data set with 
