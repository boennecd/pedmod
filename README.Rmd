...
primary interest in an analysis. We fix the unshared random effect to have 
variance one which gives the one in the denominator. Other authors prefer that
